...
Original file is located at
    https://colab.research.google.com/drive/1qQCvgXh4G6rXE8OXPQbjnkbf-foJ9noO
"""
...
st.title("Garment Box Packing Tool")

uploaded_file = st.file_uploader("Upload the ASSORTED Excel file", type=["xlsx"])
